...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Jul 16, 2022 at 03:39 AM
...
INSERT INTO `detail_barang` (`id`, `NoOrder`, `IdBarang`, `Jumlah`) VALUES
(1, '8684', 'B01', 1),
(2, '8684', 'B02', 5),
(3, '8684', 'B03', 4),
(4, '8684', 'B04', 1),
...
INSERT INTO `detail_layanan` (`id`, `NoOrder`, `IdLayanan`) VALUES
(1, '8684', 'L04'),
(2, '3213', 'L02'),
(3, '10023', 'L02'),
(4, '28323', 'L03'),
...
INSERT INTO `layanan` (`IdLayanan`, `NamaLayanan`, `Harga`) VALUES
('L01', 'Ekonomis', 3000),
('L02', 'Reguler', 6000),
('L03', 'Kilat', 8000),
('L04', 'Express', 10000),
...
INSERT INTO `pelanggan` (`IdPelanggan`, `Nama`, `Alamat`, `NoHp`) VALUES
...
INSERT INTO `pemesanan` (`NoOrder`, `IdPelanggan`, `TglMasuk`, `TglSelesai`, `Berat`, `TotalHarga`) VALUES
...
('3213', 'P0002', '2021-07-22', '2021-08-25', 2.35, 14100),
...
ALTER TABLE `detail_barang`
  ADD CONSTRAINT `detail_barang_ibfk_1` FOREIGN KEY (`NoOrder`) REFERENCES `pemesanan` (`NoOrder`),
  ADD CONSTRAINT `detail_barang_ibfk_2` FOREIGN KEY (`IdBarang`) REFERENCES `barang` (`IdBarang`);

--
-- Constraints for table `detail_layanan`
--
ALTER TABLE `detail_layanan`
  ADD CONSTRAINT `detail_layanan_ibfk_1` FOREIGN KEY (`NoOrder`) REFERENCES `pemesanan` (`NoOrder`),
  ADD CONSTRAINT `detail_layanan_ibfk_2` FOREIGN KEY (`IdLayanan`) REFERENCES `layanan` (`IdLayanan`);
